...
from .views import index, register_user, activate_account, resend_activation_link, custom_logout, password_change_view
...
urlpatterns = [
    ...
    # this line includes the default auth urls 
    ...
    # you can add a custom view for e. g. the register, password_change or logout view if you want to
